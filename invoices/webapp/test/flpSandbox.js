		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices",
									"targetURL": "#logaligroupcominvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupcominvoices-display": {
								"semanticObject": "logaligroupcominvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.com.invoices",
									"url": sap.ui.require.toUrl("logaligroup/com/invoices")
								}
							}
						}
					}
